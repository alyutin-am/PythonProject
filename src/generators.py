...
def transaction_descriptions(transaction_descr: list[dict]) -> GeneratorExit[str, None, None]:
...
def card_number_generator(start: int = 1, stop: int = 9999999999999999) -> GeneratorExit[str, None, None]:
    """
